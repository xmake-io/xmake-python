...
- xmake-platlib: `/../platlib` -> `/tmp/tmpXXXXXXXX/platlib` -> `example.py`,
  ...
- xmake-scripts: `/bin` -> `/tmp/tmpXXXXXXXX/data/bin` ->
  `example-0.0.1.data/scripts`
- xmake-headers: `/bin` -> `/tmp/tmpXXXXXXXX/data/headers` ->
  `example-0.0.1.data/headers`
- xmake-data: `/bin` -> `/tmp/tmpXXXXXXXX/data/headers` ->
  `example-0.0.1.data/headers`
- xmake-metadata: `/bin` -> `/tmp/tmpXXXXXXXX/data/headers` ->
  `example-0.0.1.data/headers`
